...
async def chat_endpoint():
    ...
    <head>
        ...
        <title>DeerFlow Chat Interface</title>
        <style>
            body {
    ...
    <body>
        <div class="header">
            <h1>🦌 DeerFlow Chat Interface</h1>
            <p>Interface de chat intelligente avec IA</p>
        </div>

        <div class="chat-container">
            <div class="chat-messages" id="chatMessages">
                <div class="message bot-message">
                    Bonjour ! Je suis DeerFlow, votre assistant IA. Comment puis-je vous aider aujourd'hui ?
                </div>
            </div>
        ...
        <div class="info-box">
            ...
            <p><strong>API Endpoint:</strong> <code>/api/chat/stream</code></p>
            <p><strong>Méthode:</strong> POST</p>
            <p><strong>Format:</strong> JSON avec clé "message"</p>
            <p><strong>Documentation:</strong> <a href="/docs" style="color: #ffd700;">/docs</a></p>
            <p><strong>JSON API:</strong> <a href="/chat-json" style="color: #ffd700;">/chat-json</a></p>
        </div>
            ...
            async function sendMessage() {
                ...
                try {
                    ...
                    if (response.ok) {
                        ...
                        addMessage('Erreur: Impossible de communiquer avec l\'API', false);
                    }
                } catch (error) {
...
async def chat_json_endpoint():
    """Chat JSON endpoint for API users"""
    return {
